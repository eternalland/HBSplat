...
from arguments import ModelParams, SparseParams
from utils.camera_utils import cameraList_from_camInfos, camera_to_JSON
from utils import get_mono_depth
import sys
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, sparse_args : SparseParams, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        """b
        ...
        if "Waymo" in args.source_path:
            ...
            scene_info = sceneLoadTypeCallbacks["Tanks"](args.source_path, args.images, args.eval, sparse_args)
            ...
            scene_info = sceneLoadTypeCallbacks["DTU"](args.source_path, args.images, args.eval, sparse_args)
        elif os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval, sparse_args)
        elif os.path.exists(os.path.join(args.source_path, "transforms_train.json")):
            print("Found transforms_train.json file, assuming Blender data set!")
            scene_info = sceneLoadTypeCallbacks["Blender"](args.source_path, args.white_background, args.eval, sparse_args)
        else:
        ...
        self.gaussians.common_matched_data = scene_info.common_matched_data
    ...
    def setVirtualCameras(self, virtual_cams):
        self.virtual_cams = virtual_cams

    def getVirtualCameras(self):
        return self.virtual_cams
